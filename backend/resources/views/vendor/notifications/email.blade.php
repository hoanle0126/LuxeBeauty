...
<head>
    ...
    <title>{{ $subject ?? 'Email từ ' . config('app.name') }}</title>
    <style>
        /* Reset styles */
        body, table, td, p, a {
            margin: 0;
                    ...
                    <div class="email-wrapper">
                        ...
                        <div class="email-body">
                            ...
                            @isset($actionText)
                                ...
                                @if(isset($actionText) && str_contains(strtolower($actionText), 'reset') || str_contains(strtolower($actionText), 'đặt lại'))
                            ...
                            @isset($actionText)
                                ...
                                <div class="footer-text">
                                    ...
                                    <span class="link-text">{{ $displayableActionUrl }}</span>
                                </div>
                            @endisset
                        </div>
